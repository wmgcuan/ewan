...
console.warn = function () {
  console.log(handle(arguments, { color: 'yellow', icon: 'warn' }))
}
console.error = function () {
  console.log(handle(arguments, { color: 'red', icon: 'error' }))
}
...
console.info = function () {
  console.color({ color: 'blue' }, ' : ' + arguments[0])
}
console.list = function () {
  console.color({ color: 'cyan' }, ' > ' + arguments[0])
}
console.title = function () {
  console.color({ color: 'grey' }, arguments[0] + ':')
}
