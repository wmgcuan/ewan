...
@font-face {
  font-family: 'icomoon';
  src: url('./fonts/icomoon.eot?3s1z7x');
  src: url('./fonts/icomoon.eot?3s1z7x#iefix')
      format('embedded-opentype'),
    url('./fonts/icomoon.ttf?3s1z7x') format('truetype'),
    url('./fonts/icomoon.woff?3s1z7x') format('woff'),
    url('./fonts/icomoon.svg?3s1z7x#icomoon') format('svg');
  font-weight: normal;
  font-style: normal;
}
.icon-fasong {
